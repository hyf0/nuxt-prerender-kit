 ...
 * Used with the Vite transform plugin to ensure `useBuildAsyncData` handlers
...
export function neverReachable(): never {
  throw new Error(
    '[nuxt-ssg] This function should never be called. ' +
      'It indicates that useBuildAsyncData was invoked outside of prerender context. ' +
